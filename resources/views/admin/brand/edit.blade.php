                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-center justify-content-between">
                            <span class="fw-bolder col-md-auto">Edit brand</span>
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form action="{{route('brand.update', $brand->id)}}" method="POST" enctype="multipart/form-data" class="">
                            @method('PUT')
                            @csrf
                            <div class="container">
                                <div class="row my-3">
                                ...
                                <div class="row my-3">
                                    ...
                                    <div class="col-md-8">
                                        <textarea name="description"
                                                  class="form-control shadow-none">{{$brand->description}}</textarea>
                                ...
                                <div class="row my-3">
                                    ...
                                    <div class="col-md-8">
                                        <input type="file" class="form-control shadow-none" accept="image/*"
                                               name="image">
                                        @if($brand->image)
                                            <img src="{{asset($brand->image)}}" alt="{{$brand->name}}" class=""
                                                 width="80" height="50">
                                        @endif
                                        @if($errors->has('image'))
