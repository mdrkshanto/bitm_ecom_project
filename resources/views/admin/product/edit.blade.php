                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row align-center justify-content-between">
                            <span class="fw-bolder col-md-auto">Update product</span>
                        ...
                        <form action="{{route('product.update', $product->id)}}" method="POST"
                            ...
                            <div class="container">
                                ...
                                <div class="row my-3">
                                    ...
                                    <div class="col-md-8">
                                        <textarea name="short_description"
                                                  class="form-control shadow-none">{!! $product->short_description !!}</textarea>
                                ...
                                <div class="row my-3">
                                    ...
                                    <button class="col-md-8 shadow-none btn btn-success btn-sm" type="submit">Update product</button>
                                </div>
                            </div>
                        </form>
                    </div>
