                ...
                <div class="col-lg-8 col-12 custom-padding-right">
                    <div class="slider-head">
                        ...
                        <div class="hero-slider">
                            ...
                            <div class="single-slider" style="background-image: url({{asset('/')}}ecom/assets/images/hero/slider-bg1.jpg);">
                                <div class="content">
                            ...
                            <div class="single-slider" style="background-image: url({{asset('/')}}ecom/assets/images/hero/slider-bg2.jpg);">
                                <div class="content">
                ...
                <div class="col-lg-4 col-12">
                    <div class="row">
                        <div class="col-lg-12 col-md-6 col-12 md-custom-padding">
                            ...
                            <div class="hero-small-banner" style="background-image: url('{{asset('/')}}ecom/assets/images/hero/slider-bnr.jpg');">
                                <div class="content">
                                    <h2>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-category">
                        ...
                        <div class="images">
                            <img src="{{asset('/')}}ecom/assets/images/featured-categories/fetured-item-1.png" alt="#">
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-category">
                        ...
                        <div class="images">
                            <img src="{{asset('/')}}ecom/assets/images/featured-categories/fetured-item-2.png" alt="#">
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-category">
                        ...
                        <div class="images">
                            <img src="{{asset('/')}}ecom/assets/images/featured-categories/fetured-item-3.png" alt="#">
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-category">
                        ...
                        <div class="images">
                            <img src="{{asset('/')}}ecom/assets/images/featured-categories/fetured-item-4.png" alt="#">
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-category">
                        ...
                        <div class="images">
                            <img src="{{asset('/')}}ecom/assets/images/featured-categories/fetured-item-5.png" alt="#">
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-category">
                        ...
                        <div class="images">
                            <img src="{{asset('/')}}ecom/assets/images/featured-categories/fetured-item-6.png" alt="#">
                        </div>
                    </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-12">
                    ...
                    <div class="single-product">
                        <div class="product-image">
                            <img src="{{asset('/')}}ecom/assets/images/products/product-1.jpg" alt="#">
                            <div class="button">
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    ...
                    <div class="single-product">
                        <div class="product-image">
                            <img src="{{asset('/')}}ecom/assets/images/products/product-2.jpg" alt="#">
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    ...
                    <div class="single-product">
                        <div class="product-image">
                            <img src="{{asset('/')}}ecom/assets/images/products/product-3.jpg" alt="#">
                            <div class="button">
                                <a href="product-details.html" class="btn"><i class="lni lni-cart"></i> Add to Cart</a>
                            </div>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    ...
                    <div class="single-product">
                        <div class="product-image">
                            <img src="{{asset('/')}}ecom/assets/images/products/product-4.jpg" alt="#">
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    ...
                    <div class="single-product">
                        <div class="product-image">
                            <img src="{{asset('/')}}ecom/assets/images/products/product-5.jpg" alt="#">
                            <div class="button">
                                <a href="product-details.html" class="btn"><i class="lni lni-cart"></i> Add to Cart</a>
                            </div>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    ...
                    <div class="single-product">
                        <div class="product-image">
                            <img src="{{asset('/')}}ecom/assets/images/products/product-6.jpg" alt="#">
                            <div class="button">
                                <a href="product-details.html" class="btn"><i class="lni lni-cart"></i> Add to Cart</a>
                            </div>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    ...
                    <div class="single-product">
                        <div class="product-image">
                            <img src="{{asset('/')}}ecom/assets/images/products/product-7.jpg" alt="#">
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    ...
                    <div class="single-product">
                        <div class="product-image">
                            <img src="{{asset('/')}}ecom/assets/images/products/product-8.jpg" alt="#">
                            <div class="button">
                                <a href="product-details.html" class="btn"><i class="lni lni-cart"></i> Add to Cart</a>
                            </div>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-12 col-12">
                    <div class="offer-content">
                        <div class="image">
                            <img src="{{asset('/')}}ecom/assets/images/offer/offer-image.jpg" alt="#">
                            <span class="sale-tag">-50%</span>
                        </div>
                        <div class="text">
            ...
            <div class="brands-logo-wrapper">
                <div class="brands-logo-carousel d-flex align-items-center justify-content-between">
                    <div class="brand-logo">
                        <img src="{{asset('/')}}ecom/assets/images/brands/01.png" alt="#">
                    </div>
                    <div class="brand-logo">
                        <img src="{{asset('/')}}ecom/assets/images/brands/02.png" alt="#">
                    </div>
                    <div class="brand-logo">
                        <img src="{{asset('/')}}ecom/assets/images/brands/03.png" alt="#">
                    </div>
                    <div class="brand-logo">
                        <img src="{{asset('/')}}ecom/assets/images/brands/04.png" alt="#">
                    </div>
                    <div class="brand-logo">
                        <img src="{{asset('/')}}ecom/assets/images/brands/05.png" alt="#">
                    </div>
                    <div class="brand-logo">
                        <img src="{{asset('/')}}ecom/assets/images/brands/06.png" alt="#">
                    </div>
                    <div class="brand-logo">
                        <img src="{{asset('/')}}ecom/assets/images/brands/03.png" alt="#">
                    </div>
            ...
            <div class="row">
                    ...
                    <div class="single-blog">
                        <div class="blog-img">
                            <a href="blog-single-sidebar.html">
                                <img src="{{asset('/')}}ecom/assets/images/blog/blog-1.jpg" alt="#">
                            </a>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-blog">
                        <div class="blog-img">
                            <a href="blog-single-sidebar.html">
                                <img src="{{asset('/')}}ecom/assets/images/blog/blog-2.jpg" alt="#">
                            </a>
                        </div>
                        <div class="blog-content">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="single-blog">
                        <div class="blog-img">
                            <a href="blog-single-sidebar.html">
                                <img src="{{asset('/')}}ecom/assets/images/blog/blog-3.jpg" alt="#">
                            </a>
                        </div>
                        <div class="blog-content">
