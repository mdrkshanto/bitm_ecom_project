                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-images">
                            <main id="gallery">
                                <div class="main-img">
                                    <img src="{{asset($product->image)}}" id="current" alt="{{$product->image}}"  height="600">
                                </div>
                                <div class="images">
                                    <img src="{{asset($product->image)}}" class="img" alt="{{$product->image}}">
                                    @foreach($product->otherImages as $otherImage)
                                    <img src="{{asset($otherImage->image)}}" class="img" alt="{{$product->image}}">
                                    @endforeach
                                </div>
                            </main>
                        </div>
                        ...
                        <div class="single-block">
                            <div class="reviews">
                                ...
                                <div class="single-review">
                                    <img src="{{asset('/')}}ecom/assets/images/blog/comment1.jpg" alt="#">
                                ...
                                <div class="single-review">
                                    <img src="{{asset('/')}}ecom/assets/images/blog/comment2.jpg" alt="#">
                                    <div class="review-info">
                                ...
                                <div class="single-review">
                                    <img src="{{asset('/')}}ecom/assets/images/blog/comment3.jpg" alt="#">
                                    <div class="review-info">
